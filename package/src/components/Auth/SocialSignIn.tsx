    ...
    <>
      <div className="flex gap-2 sm:gap-4">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 sm:gap-2.5 rounded-lg border border-solid hover:bg-stroke border-stroke p-2.5 sm:p-3.5 text-xs sm:text-sm text-dark duration-200 ease-in dark:border-dark_border dark:text-white dark:hover:bg-primary/10 hover:bg-primary/10"
        >
          ...
          <svg
            ...
            className="w-5 h-5 sm:w-[23px] sm:h-[22px]"
          >
