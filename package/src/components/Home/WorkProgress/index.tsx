...
import CareerGrowthIllustration from '@/components/Home/CareerGrowthIllustration'
        ...
        <div className='grid md:grid-cols-12 items-center gap-7'>
          ...
          <div
            ...
            <h2 className='pt-9 pb-8 text-midnight_text font-bold dark:text-white text-4xl'>
              End-to-End Job Search Support Made Easy
            </h2>
            <p className='text-gray dark:text-white/70 text-base font-semibold'>
              We update your resume, manually apply for relevant jobs, follow up with recruiters, and support you until placement.
            </p>
