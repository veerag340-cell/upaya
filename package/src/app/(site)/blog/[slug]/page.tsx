...
export default async function Post({ params }: any) {
  ...
  return (
    <>
      ...
      <section className='pb-10 pt-14 dark:bg-darkmode lg:pb-20'>
        <div className='container max-w-6xl mx-auto'>
                  ...
                  <div>
                    <div className='-mx-4 mb-8 flex flex-col'>
                      <div className='w-full py-12 px-11 bg-white dark:bg-darklight shadow-lg border-b-2 border-lightborder dark:border-dark_border rounded-t-lg'>
                        <h2
                          className='wow fadeInUp relative mb-5 text-2xl dark:text-white text-black  sm:text-[28px] leading-tight'
                          data-wow-delay='.1s'>
                          Share
                        </h2>
                      ...
                      <div className='w-full py-12 px-11 bg-white dark:bg-darklight shadow-lg rounded-b-lg'>
                        ...
                        <input
                          ...
                          className='p-3 dark:bg-transparent border border-border dark:border-dark_border rounded-lg mb-2 w-full focus:outline-0 dark:focus:border-primary focus:border-primary'
                        />
      ...
      <div className='bg-SnowySky dark:bg-darklight'>{/* <BlogSmall /> */}</div>
    </>
  )
}
